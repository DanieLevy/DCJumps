...
import { ArchiveBoxIcon, ArrowPathIcon, DocumentDownloadIcon } from '@heroicons/react/24/outline';
import LoadingSpinner from '../LoadingSpinner';
import ErrorAlert from '../ErrorAlert';

interface DatacoMergerProps {
  dataco: any[];
  baseDir: string;
}

export default function DatacoMerger({ dataco, baseDir }: DatacoMergerProps) {
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          <div className="px-4 py-5 sm:p-6">
            <div className="flex justify-between items-center mb-4">
              ...
              >
                <DocumentDownloadIcon className="-ml-0.5 mr-2 h-4 w-4" />
